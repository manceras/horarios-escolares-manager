...
from app.api.deps import AnyUser, ClassGroupServiceDep, StaffUser
...
def list_class_groups(service: ClassGroupServiceDep, _user: AnyUser) -> Sequence[ClassGroup]:
    return service.list_all()


@router.get("/{class_group_id}", response_model=ClassGroupRead)
def get_class_group(
    class_group_id: int, service: ClassGroupServiceDep, _user: AnyUser
) -> ClassGroup:
...
def create_class_group(
    payload: ClassGroupCreate, service: ClassGroupServiceDep, _user: StaffUser
) -> ClassGroup:
...
def update_class_group(
    class_group_id: int, payload: ClassGroupUpdate, service: ClassGroupServiceDep, _user: StaffUser
) -> ClassGroup:
...
def delete_class_group(
    class_group_id: int, service: ClassGroupServiceDep, _user: StaffUser
) -> None:

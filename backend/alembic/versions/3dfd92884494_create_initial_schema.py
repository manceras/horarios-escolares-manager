...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['tutor_id'], ['teachers.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
    ...
    op.create_table('curriculum_entries',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('schedule_id', 'curriculum_entry_id', 'time_slot_id', name='uq_session_schedule_entry_slot')
    )
